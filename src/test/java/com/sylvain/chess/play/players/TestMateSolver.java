...
public class TestMateSolver {
  ...
  public void testMatDuBerger() {
    ...
    final MateSolver mateIn1 = new MateSolver(PlayerColor.WHITE, board, 2);
  ...
  public void testMatDeLimbecile() {
    ...
    final MateSolver mateIn1 = new MateSolver(PlayerColor.BLACK, board, 2);
  ...
  public void testMateIn2() {
    ...
    final MateSolver mateIn2 = new MateSolver(PlayerColor.WHITE, board, 2);
  ...
  public void testMateIn5() {
    ...
    final MateSolver mateIn2 = new MateSolver(PlayerColor.BLACK, board, 5);
